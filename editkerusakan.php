    ...
    <h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
      ...
      <form action="<?= base_url('kerusakan/edit/'.$k['id']);?>" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="keterangan" value="<?php echo $k['keterangan'] ?>" >
          </div>
        </div>
        ...
        <div class="form-group row">
          <div class="col-sm-10">
            ...
            <button href="<?= base_url('kerusakan') ?>" type="submit" class="btn btn-primary">Kembali</button>
          </div>
        </div>
      </form>
