          ...
          <div class="row">
          	<div class="col-lg-6">
                  ...
                  <?php echo '|' ?>
				      	...
				      	<a href="<?php echo base_url('menu/delete/'.$m['id']) ?>" onclick="javascript: return confirm('Apakah yakin menghapus')" class="badge badge-danger"><i class="fas fa-trash-alt"></i> Hapus</a>
